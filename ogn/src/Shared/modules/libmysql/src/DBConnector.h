...
public: // Õ¨≤Ω;
	int8* doQuery(const DBRecord& query_record, DBRecord* result_records, uint32& result_count, const uint32 result_max_count = 0);
	int8* doQuery(const DBRecord& query_record, DBRecord* result_records, uint32& result_count, const std::string& compare_record_names, const std::string& return_record_names, int32 result_max_count = 0);
